...
import '../../styles/Managers/Staffs.css'
...
export default function ManagerStaffMain() {
	...
	useEffect(() => {
		StaffService.getWatchmenByTower()
			.then(res => {
				if (res.status === 200) {
					console.log(res.data);
					setWatchmen(res.data)
				}
			})
			.catch(err => {
				console.log(err);
			})
		StaffService.getWorkersByTower()
			.then(res => {
				if (res.status === 200) {
					console.log(res.data)
					setWorkers(res.data)
